...
export default function Home(): React.JSX.Element {
	return (
		<div className="h-screen overflow-hidden">
			<BackGround />
			<main className="z-1 flex h-full flex-grow flex-col justify-between bg-gray-300 bg-opacity-60 backdrop-filter dark:bg-gray-900 dark:bg-opacity-60">
				...
				<section className="flex flex-grow flex-col items-center justify-center px-[9.8vh]">
